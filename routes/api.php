...
Route::group(['prefix' => 'v1', 'as' => 'api.', 'namespace' => 'App\Http\Controllers\Api\V1\Admin', 'middleware' => ['auth:api']], function () {
    ...
    // Bus
    Route::apiResource('buses', BusesApiController::class);

    // Rides
    Route::apiResource('trips', RidesApiController::class);

    // Bookings
    Route::apiResource('bookings', BookingsApiController::class);
});
